...
export const languageInfoData: LanguageInfo = {
  ...
  "csharp": {
    ...
    "features": [
      ...
      "It's the only C# tool that shows the image on hover on Image URL in a tree view.",
    ...
    "additional_info": [
      ...
      "C# Full Form",
      "What is C#?",
      "C# Example with all data types including C# Array.",
      "Python Pretty Print C#",
      "Read C# File Using Python",
      "Validate C# using PHP",
      "Python Load C# From File",
    ],
    "tools": [
  ...
  "proto": {
    ...
    "features": [
      ...
      "It's the only Proto tool that shows the image on hover on Image URL in a tree view.",
    ...
    "additional_info": [
      ...
      "Proto Full Form",
      "What is Proto?",
      "Proto Example with all data types including Proto Array.",
      "Python Pretty Print Proto",
      "Read Proto File Using Python",
      "Validate Proto using PHP",
      "Python Load Proto From File",
    ],
    "tools": [
  ...
  "zig": {
    ...
    "features": [
      ...
      "It's the only Zig tool that shows the image on hover on Image URL in a tree view.",
      "It's also a Zig Beautifier that supports indentation levels: 2 spaces, 3 spaces, and 4 spaces.",
      "Supports printing of Zig data.",
    ],
    "additional_info": [
      "How to Create Zig File?",
      "Zig Full Form",
      "What is Zig?",
      "Zig Example with all data types including Zig Array.",
      "Python Pretty Print Zig",
      "Read Zig File Using Python",
      "Validate Zig using PHP",
      "Python Load Zig From File",
    ],
    "tools": [
