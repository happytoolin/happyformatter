  ...
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      <select
        ...
        className="text-xs font-mono bg-secondary border border-foreground px-2 py-1 focus:outline-none focus:ring-1 focus:ring-primary hover:bg-accent transition-colors"
      >
