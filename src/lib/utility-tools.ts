...
export const UTILITY_TOOLS: UtilityTool[] = [
  {
    ...
    keywords: "private json viewer, json viewer online, json pretty print, validate json online, no upload json viewer",
  ...
  },
  {
    ...
    keywords: "json diff, compare json, json difference tool, side by side json diff, private json comparison",
  ...
  },
  {
    ...
    description:
      "Convert arrays of JSON objects to CSV locally in your browser for spreadsheets, reports, data checks, and quick exports.",
    keywords: "json to csv, convert json to csv, json array to csv, private csv converter, browser json csv",
  ...
  },
  {
    ...
    category: "colors",
    title: "Private Color Converter - HEX RGB HSL No Upload | HappyFormatter",
    description:
      "Convert HEX, RGB, and HSL colors locally in your browser for CSS variables, design tokens, palettes, and theme checks.",
    keywords: "color converter, hex to rgb, rgb to hsl, hsl to hex, css color converter, private color converter",
